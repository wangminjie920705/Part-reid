...
savepath='/home/wangminjie/Desktop/wmj/projects/Part-reID/features'
...
class MGN(nn.Module):
    ...
    def forward(self, x):
        ...
        #draw_features(1, 1, x.cpu().detach().numpy(), "{}/Part-pic{}.png".format(savepath,self.num))
        #self.num=self.num+1
        # if self.num==1:
        #     draw_features(1, 1, x.cpu().detach().numpy(), "{}/Part-pic{}.png".format(savepath,self.num))
        # self.num=self.num+1
     ...
     ##pixel attention
        #att_p1=self.attention2(p1)
        #att_p2=self.attention2(p2)
        #att_p3=self.attention2(p3)
        #p1=p1*att_p1
        #p2=p2*att_p2
        #p3=p3*att_p3
