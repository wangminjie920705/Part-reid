...
class MGN(nn.Module):
    ...
    def forward(self, x):
        ...
        x4 = torch.cat([x1.unsqueeze(dim=1),x2.unsqueeze(dim=1),x3.unsqueeze(dim=1)],dim=1)
        x4 = self.fusion_conv(x4)
        ...
        predict = torch.cat([fg_p1, fg_p2, fg_p3, x1, x2, x3, x4, f0_p2, f1_p2, f0_p3, f1_p3, f2_p3], dim=1)

        return predict, fg_p1, fg_p2, fg_p3, x1, x2, x3, x4, l_p1, l_p2, l_p3, l0_p2, l1_p2, l0_p3, l1_p3, l2_p3
